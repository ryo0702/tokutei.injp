...
$page_title = 'inJP技能実習生について';
$page_description = 'inJP技能実習生は制度上の問題点を利用した監理団体の既得権益などをなくし、公平にするために運営しています。監理団体同士が既得権を守り、競争をしないため、価格やサービス、またクローズドな環境で、技能実習生への不当な監理が行われてしまいます。inJP技能実習は本来は堅牢な制度の外国人技能実習制度を、自由競争をもってこれらのイシューを改善する第一歩だと考え、ポリシーを持って取り組んでいます。';

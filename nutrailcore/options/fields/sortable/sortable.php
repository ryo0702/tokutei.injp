 ...
 *
 */
if (!class_exists('WPA_Field_sortable')) {
    class WPA_Field_sortable extends WPA_Fields
    {
        ...
        public function render()
        {
            ...
            foreach ($pre_sortby as $key => $field) {
                ...
                echo '<div class="wpa--sortable-item">';

                echo '<div class="wpa--sortable-content">';
                ...
                echo WPA::field($field, $field_value, $unique_id, 'field/sortable');

                echo '</div>';

                echo '<div class="wpa--sortable-helper"><i class="fa fa-arrows"></i></div>';

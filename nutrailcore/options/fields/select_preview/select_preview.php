 ...
 *
 */
if (!class_exists('WPA_Field_select_preview')) {
    class WPA_Field_select_preview extends WPA_Fields
    {
        ...
        public function render()
        {
            ...
            if (isset($this->field['options'])) {
                ...
                echo '<select name="'.$this->field_name().'"'.$this->field_attributes().' class="wpa_select_preview">';

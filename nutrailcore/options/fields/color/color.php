 ...
 *
 */
if (!class_exists('WPA_Field_color')) {
    class WPA_Field_color extends WPA_Fields
    {
        ...
        public function render()
        {
            ...
            echo '<input type="text" name="'.esc_attr($this->field_name()).'" value="'.esc_attr($this->value).'" class="wpa-color"'.$default_attr.$this->field_attributes().'/>';

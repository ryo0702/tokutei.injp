    ...
    class WPA_Field_media extends WPA_Fields
    {
        ...
        public function render()
        {
            ...
            $args = wp_parse_args($this->field, array(
                ...
                'preview'      => true,
                'library'      => array(),
                'button_title' => esc_html__('Upload', 'nutrail'),
                'remove_title' => esc_html__('Remove', 'nutrail'),
            ...
            $placeholder = (empty($this->field['placeholder'])) ? ' placeholder="'.esc_html__('No media selected', 'nutrail').'"' : '';

    ...
    class WPA_Field_group extends WPA_Fields
    {
        ...
        public function render()
        {
            ...
            $args = wp_parse_args($this->field, array(
                ...
                'min'                    => 0,
                'fields'                 => array(),
                'button_title'           => esc_html__('Add New', 'nutrail'),
            ...
            if (preg_match('/'.preg_quote('['.$this->field['id'].']').'/', $this->unique)) {
                ...
                echo '<i class="wpa-cloneable-remove wpa-confirm fas fa-times" data-confirm="'.esc_html__('Are you sure to delete this item?', 'nutrail').'"></i>';
                echo '</div>';

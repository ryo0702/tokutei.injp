<div class="page_contact">
    <div class="container_s">
        <div class="page_title"><h1>利用規約</h1></div>
        <div class="page_content">


        <div class="rule">
<p>この利用規約（以下，「本規約」といいます。）は，合同会社ニッチャーズ（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
...
<ol>
<li>当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーのお見積り等の登録を抹消することができるものとします。
<ol>
...
<h2>第5条（情報の削除・訂正）</h2>
<p>ユーザーは，法人名が掲載された見積もりの場合、本人確認ができ、削除・訂正を求められた場合、本サービスより情報を削除・訂正できるものとします。</p>
